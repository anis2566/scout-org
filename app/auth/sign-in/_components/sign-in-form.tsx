    ...
    return (
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                <div>
                    <h1 className="text-center text-xl font-semibold text-primary border-b border-primary max-w-fit mx-auto border-b-2">Sign In</h1>
                </div>
                <FormField
                ...
                <div className="flex justify-between items-center flex-wrap">
                    ...
                    <Button variant="linkHover2" asChild className="text-muted-foreground text-primary" disabled={isPending}>
